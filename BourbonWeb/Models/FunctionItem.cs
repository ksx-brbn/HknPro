namespace BourbonWeb.Models
{
    public class FunctionItem
    {
        ...
        public string Touroku { get; set; } = string.Empty;
        public string Koushin { get; set; } = string.Empty;
        public string Sakujo { get; set; } = string.Empty;
        public string Chouhyou { get; set; } = string.Empty;
        public string In { get; set; } = string.Empty;
        public string Out { get; set; } = string.Empty;
        public string Bikou { get; set; } = string.Empty;
        public string KyuuId { get; set; } = string.Empty;
    }
}
